...
<html lang="es">
	...
	<style>
			body{
					...
					background-image: url('fondo-fondos.png');
	...
	<body align="center">
		...
		<table style="font-family: this cafe; font-size: 65px" class="text-center"><thead><tr><th> CAMBIO DE FONDO</th></tr></thead></table><br>
				...
				?>
							...
							<table style="font-family: pixeled; font-size: 9px" class="table table-hover table-bordered table-dark table-sm align-middle table caption-top w-50 p-3" border="7" align="center">
								...
								<tbody class="text-center">
									<tr>
										<td><?php echo "<div align='center'><img class='img-thumbnail border-0' src='$fondos ?>' width='200' height='200'></div>"; ?> </td>
										<td><button class="btn btn-dark btn-sm" style='color-white' onclick="confirmChange('<?php echo $fondos; ?>')"><div align='center'><img src='imagenes/check.png' width='35' height='35'></div></a></button></td>
									</tr>
					<?php
						}
					?>
			...
			<script>
				function confirmChange(avatar) 
				{
					...
					({
						title: '¿Estás seguro?',
						text: "¿Deseas cambiar tu fondo actual por este? Los cambios se verán al reiniciar la sesión.",
						icon: 'warning',
				...
				if(isset($_GET['editar']))
					{
						...
						$update="UPDATE perfiles SET papel='$editar_id' WHERE id='$usuario';";
												
						$ejecutar1=mysqli_query($conn,$update);
							if ($ejecutar1) 
								{
									echo "<script>href='fondos.php'</script>";
								}
							else
								{
